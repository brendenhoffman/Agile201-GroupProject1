...
namespace Agile201_GroupProject1
{
    public partial class UpdateProductForm : Form
    {
        ...
        private void updateButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Description cannotbe empty");
            ...
            else if (!string.IsNullOrEmpty(newQuantityTextBox.Text) && !int.TryParse(newQuantityTextBox.Text, out newArrival) || newArrival < 0)
            {
